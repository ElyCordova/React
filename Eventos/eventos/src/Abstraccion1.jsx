...
/*componente que arma una lista desplegable*/
...
const Abstraccion1 = () => {
    const [option, setOption] = useState(1); /*comienza con ese valor por defecto: 1*/
    const options = [{value: 1, text:"Azul"}, {value: 2, text:"Rojo"}, {value: 3, text:"Celeste"},]
